...
//     'id' => 5
// ];
// $get_data = callAPI('GET', '10.33.72.6/book-api/public/show', $data);
// print_r($get_data);
...
//     'author'=> 'Penulis 2'
// ];
// $update_plan = callAPI('PUT', '10.33.72.6/book-api/public/update', json_encode($data));
// print_r($update_plan);
...
$delete = callAPI('DELETE', '10.33.72.6/book-api/public/delete', $data);
print_r($delete);
